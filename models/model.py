...
class PeakSetSIGReg(nn.Module):
    ...
    def forward_augmented(
        ...
        peak_mz_targets = peak_mz.repeat_interleave(K, dim=0)
        peak_intensity_targets = peak_intensity.repeat_interleave(K, dim=0)
        peak_valid_targets = peak_valid_mask.repeat_interleave(K, dim=0)
