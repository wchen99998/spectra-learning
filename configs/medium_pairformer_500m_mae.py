...
def get_config() -> config_dict.ConfigDict:
    ...
    cfg.encoder_fourier_mlp_hidden_dim = 1920
    ...
    cfg.feature_mlp_hidden_dim = 1920
    cfg.pairformer_pair_dim = 640
    cfg.pairformer_pair_num_heads = 20
    cfg.pairformer_pair_feature_hidden_dim = 1280
    ...
    cfg.run_name_suffix = "mae-500m-pairformer"
