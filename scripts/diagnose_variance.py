...
def build_model(cfg) -> PeakSetSIGReg:
    return PeakSetSIGReg(
        ...
        mz_fourier_num_frequencies=cfg.mz_fourier_num_frequencies,
        mz_fourier_min_freq=cfg.mz_fourier_min_freq,
        mz_fourier_max_freq=cfg.mz_fourier_max_freq,
        mz_fourier_learnable=cfg.mz_fourier_learnable,
