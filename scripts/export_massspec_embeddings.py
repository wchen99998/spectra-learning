...
def _build_massspec_probe_dataset_serial(
    ...
    *,
    ...
    return _build_dataset(
        ...
        sigreg_contiguous_mask_fraction_min=datamodule.sigreg_contiguous_mask_fraction_min,
        sigreg_contiguous_mask_fraction_max=datamodule.sigreg_contiguous_mask_fraction_max,
        sigreg_random_drop_fraction_min=datamodule.sigreg_random_drop_fraction_min,
        sigreg_random_drop_fraction_max=datamodule.sigreg_random_drop_fraction_max,
